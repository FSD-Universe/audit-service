...
func (builder *ApplicationContentBuilder) SetAuditLog(auditLog repository.AuditLogInterface) *ApplicationContentBuilder {
	builder.content.auditLogRepo = auditLog
	return builder
}
